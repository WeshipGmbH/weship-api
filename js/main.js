(function ($) {
  ...
  // if ($(".tip_doc_area .nav-sidebar > li").hasClass("active")) {
  //   $(".tip_doc_area .nav-sidebar > li.active").find("ul").slideDown(700);
  // }

  // function active_dropdown3() {
  //   $(".tip_doc_area .nav-sidebar > li > a").on("click", function (e) {
  //     event.preventDefault();
  //     $(this).parent().find("ul").first().toggle(300);
  //     $(this).parent().siblings().find("ul").hide(300);
  //   });
  ...
  // $(".tip_doc_area .nav-sidebar > li > a").each(function () {
  //   var $this = $(this);
  //   $this.on("click", function (e) {
  //     event.preventDefault();
  //     var has = $this.parent().hasClass("active");
